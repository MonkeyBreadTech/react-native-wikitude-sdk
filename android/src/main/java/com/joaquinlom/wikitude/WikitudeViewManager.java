...
public class WikitudeViewManager extends ViewGroupManager<WikitudeView>
    implements ArchitectJavaScriptInterfaceListener,
  ...
  final LifecycleEventListener mLifeEventListener =
  ...
  public void onScreenCaptured(Bitmap image) {
    ...
    reactContext
        ...
        .receiveEvent(this.wikitude.getId(), "onScreenCaptured", event);
  }
  ...
  public void worldLoadFailed(int i, String s, String s1) {
    ...
    reactContext
        .getJSModule(RCTEventEmitter.class)
        .receiveEvent(wikitude.getId(), "onFailLoading", event);
  }
  ...
  public void receiveCommand(
      WikitudeView root, int commandId, @javax.annotation.Nullable ReadableArray args) {
...
class WikitudeView extends ArchitectView {
  ...
  public WikitudeView(
      Activity activity, Context ctx, String licenseKey, WikitudeViewManager manager) {
    super(activity);
    this.activity = activity;
